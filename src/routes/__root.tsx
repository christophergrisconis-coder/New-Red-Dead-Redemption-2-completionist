...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description",
        content:
          "Advanced Creation Studio provides evidence-based reentry and reintegration services for individuals, families, and government partners committed to reducing recidivism and building safer communities.",
      },
      { property: "og:title", content: "Advanced Creation Studio" },
      {
        property: "og:description",
        content:
          "Evidence-based reentry and reintegration services — trusted by government partners to reduce recidivism and build safer communities.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Advanced Creation Studio" },
      { name: "twitter:description", content: "Evidence-based reentry and reintegration services — trusted by government partners to reduce recidivism and build safer communities." },
    ...
    <html lang="en" className="dark">
      ...
      <body>
        ...
        <script
          ...
          data-cf-beacon='{"token": "08dd3cb26e754a46a5e1bcab5a86042c"}'
        />
      </body>
    </html>
  );
